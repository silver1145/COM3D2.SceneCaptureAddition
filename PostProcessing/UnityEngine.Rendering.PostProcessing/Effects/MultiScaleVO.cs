...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    internal sealed class MultiScaleVO : IAmbientOcclusionMethod
    {
        ...
        void PushDownsampleCommands(CommandBuffer cmd, Camera camera, RenderTargetIdentifier? depthMap, bool isMSAA)
        {
            ...
            var cs = m_Resources.computeShaders.multiScaleVODownsample1;
            ...
            cs = m_Resources.computeShaders.multiScaleVODownsample2;
        ...
        void PushRenderCommands(CommandBuffer cmd, int source, int destination, Vector3 sourceSize, float tanHalfFovH, bool isMSAA)
        {
            ...
            var cs = m_Resources.computeShaders.multiScaleVORender;
        ...
        {
            var cs = m_Resources.computeShaders.multiScaleVOUpsample;
            int kernel = 0;
            if (!isMSAA)
            {
        ...
        {
            var sheet = context.propertySheets.Get(m_Resources.shaders.multiScaleVO);
            sheet.ClearKeywords();

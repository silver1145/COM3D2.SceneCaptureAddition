    ...
    public sealed class AmbientOcclusion : PostProcessEffectSettings
    {
        ...
        public override bool IsEnabledAndSupported(PostProcessRenderContext context)
        {
            ...
            else if (mode.value == AmbientOcclusionMode.MultiScaleVolumetricObscurance)
            {
                if (context != null)
                {
                    state &= context.resources.shaders.multiScaleVO
                          && context.resources.shaders.multiScaleVO.isSupported
                          && context.resources.computeShaders.multiScaleVODownsample1
                          && context.resources.computeShaders.multiScaleVODownsample2
                          && context.resources.computeShaders.multiScaleVORender
                          && context.resources.computeShaders.multiScaleVOUpsample;
                }

...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class HistogramMonitor : Monitor
    {
        ...
        {
            return context.resources.computeShaders.histogram;
        }
        ...
        internal override void Render(PostProcessRenderContext context)
        {
            ...
            var compute = context.resources.computeShaders.histogram;
            ...
            var sheet = context.propertySheets.Get(context.resources.shaders.histogram);

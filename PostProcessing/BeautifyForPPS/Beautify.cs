...
namespace BeautifyForPPS {
    ...
    public sealed class BeautifyRenderer : PostProcessEffectRenderer<Beautify> {
        ...
        public override void Render(PostProcessRenderContext context) {
            ...
            PropertySheet sheet = context.propertySheets.Get(AssetLoader.beautifyPPSCore);
            sheet.ClearKeywords();
        ...
        void DoEyeAdaptation(PostProcessRenderContext context, PropertySheet sheet) {
            ...
            if (rtEAacum == null) {
                ...
                // rtEASmallDesc.vrUsage = UnityEngine.VR.VRSettings.eyeTextureDesc.vrUsage;
                rtEAacum = new RenderTexture(
                    rtEASmallDesc.width,
                    rtEASmallDesc.height,
                    rtEASmallDesc.depthBufferBits,
                    rtEASmallDesc.colorFormat,
                    rtEASmallDesc.readWrite
                );
                rtEAacum.Create();
                context.command.BlitFullscreenTriangle(rtEA[lumRT], rtEAacum, sheet, SHADER_RAW_COPY_PASS);
                rtEAHist = new RenderTexture(
                    rtEASmallDesc.width,
                    rtEASmallDesc.height,
                    rtEASmallDesc.depthBufferBits,
                    rtEASmallDesc.colorFormat,
